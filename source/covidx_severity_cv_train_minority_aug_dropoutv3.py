...
if __name__ == '__main__':
    ...
    for fold, (train_ids,test_ids) in enumerate(kfold.split(np.zeros(len(df)),y=df['label_encoded'])):
        ...
        CHECKPOINT = f'./models/{model_architecture}_covidx_severity_minaugv3_fold{fold}.pth'
    ...
    df.to_csv(f'./logs/{model_architecture}_covidx_severity_minaugv3_cvmetrics.csv')
